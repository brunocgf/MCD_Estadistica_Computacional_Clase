...
Posteriormente corremos las repeticiones

```{r poisson repeticiones}
...
kable(t(data.frame(poiss_int$normal[,2:3], poiss_int$percent[,4:5],poiss_int$bca[,4:5])), digits = 4)
```
