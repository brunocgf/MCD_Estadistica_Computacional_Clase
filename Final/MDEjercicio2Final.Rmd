...
Cargamos los datos
```{r}
gto_2012 <- read.csv("~/Downloads/gto_2012.csv")
```

Hicimos una función que nos calcula el primer estimador, lo primero que se obtiene es la simulación de una muestra aleatoria del data set con la función de sample_n.
```{r}
set.seed(141394)
